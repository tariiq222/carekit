...
Expected: حاويات `deqah-postgres` و `deqah-redis` تعمل.
...
```typescript
/**
 * Deqah — Services Extensions E2E Tests
      ...
      clientRes.status === 201
        ...
        : (
            await request(httpServer)
              ...
              .send({ email: 'client@deqah-test.com', password: 'P@tientP@ss1' })
