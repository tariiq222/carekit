# Public Website — Phase 4 (Advanced: Subscriptions + Support Groups + ZATCA QR + Refunds + SEO) Implementation Plan

> **⚠️ Plan status:** Most speculative of the four plans — written before Phases 1.5, 2, 3 land. Scope is large; expect to split Phase 4 into 4.a (Subscriptions + Groups), 4.b (ZATCA + Refunds), 4.c (SEO) based on business priority when the time comes.
