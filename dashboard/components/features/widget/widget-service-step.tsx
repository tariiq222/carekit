...
/**
 * Widget Service Step — Select practitioner, service, and booking type
 */
...
export function WidgetServiceStep({ locale, booking }: Props) {
  const {
    practitionersData,
  ...
  /* ─── Available booking types for selected service ─── */
