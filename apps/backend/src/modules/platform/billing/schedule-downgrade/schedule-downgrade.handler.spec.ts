...
const basicPlan = { id: 'plan-basic', priceMonthly: '300.00', priceAnnual: '3000.00' };
const proPlan = { id: 'plan-pro', priceMonthly: '900.00', priceAnnual: '9000.00' };
...
const buildHandler = (prisma: ReturnType<typeof buildPrisma>, cache = buildCache()) =>
  new ScheduleDowngradeHandler(prisma as never, buildTenant() as never, cache as never);
