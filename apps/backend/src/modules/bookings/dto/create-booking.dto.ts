...
export class CreateBookingDto {
  ...
  @ApiProperty({
    enum: BookingType,
    description: 'Booking type (in_person, online, walk_in)',
  })
  @IsEnum(BookingType)
  @IsNotEmpty()
  type!: BookingType;
  ...
  @ApiPropertyOptional({
    description: 'Patient notes for the practitioner',
    maxLength: 1000,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'Admin only: book on behalf of a patient by their user ID',
  })
  @IsOptional()
  @IsUUID()
  patientId?: string;
  ...
  @ApiPropertyOptional({
    description:
      'Branch ID for branch-scoped booking settings, dashboards, and reporting',
  })
  @IsOptional()
  @IsUUID()
  branchId?: string;
  ...
  @ApiPropertyOptional({
    description:
      'Duration option ID if selecting a specific duration/price option',
  })
  @IsOptional()
  @IsUUID()
  ...
  @ApiPropertyOptional({
    description: 'Skip payment — pay at clinic (cash/POS). Admin only.',
  })
  @IsOptional()
  @IsBoolean()
  payAtClinic?: boolean;
