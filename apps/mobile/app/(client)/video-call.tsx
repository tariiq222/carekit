...
const styles = StyleSheet.create({
  ...
  topBar: { position: 'absolute', start: 16, end: 16, zIndex: 30 },
  ...
  selfView: { position: 'absolute', start: 16, zIndex: 20 },
  selfGradient: {
  ...
  captionWrap: { position: 'absolute', start: 16, end: 16, zIndex: 20 },
  ...
  controlsWrap: { position: 'absolute', start: 16, end: 16, zIndex: 30 },
