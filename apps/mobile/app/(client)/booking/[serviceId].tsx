...
import { Building2, ChevronRight, Video } from 'lucide-react-native';
            ...
            >
              <View style={[styles.typeRow, { flexDirection: 'row' }]}>
                ...
                <View style={styles.typeMid}>
                  <Text style={[styles.typeLabel, { fontFamily: f700, textAlign: 'right' }]}>
                    {item.labelAr}
                  </Text>
                  <Text style={[styles.typeDesc, { fontFamily: f400, textAlign: 'right' }]}>
                    {item.descAr}
                  </Text>
                </View>
