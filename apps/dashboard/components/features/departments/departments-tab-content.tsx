    ...
    <>
      ...
      {isLoading && departments.length === 0 ? (
        ...
        <DataTable
          ...
          emptyAction={onAdd ? { label: t("departments.addDepartment"), onClick: onAdd } : undefined}
        />
      )}
      ...
      <CreateDepartmentDialog open={createOpen} onOpenChange={onCreateOpenChange ?? (() => {})} />
