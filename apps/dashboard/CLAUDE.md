# Deqah Dashboard — Next.js Admin

## Tech

Next.js 15 (App Router), React 19, TanStack Query v5, Tailwind 4, Zod, React Hook Form. UI primitives come from the `@deqah/ui` workspace package (extracted in SaaS-05a). Custom i18n runtime — `next-intl` is installed but not used at runtime.
