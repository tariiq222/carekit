...
export const enBilling: Record<string, string> = {
  ...
  "billing.invoices.action.download": "Download PDF",
  "billing.invoices.action.downloading": "Preparing...",
  "billing.invoices.action.downloadFailed": "Could not prepare invoice. Please try again.",
