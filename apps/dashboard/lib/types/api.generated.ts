...
export interface paths {
    ...
    "/api/v1/dashboard/platform/feature-flags": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["DashboardPlatformController_listFeatureFlagsEndpoint"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/dashboard/platform/feature-flags/map": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get a key→enabled map of all feature flags */
        get: operations["DashboardPlatformController_featureFlagMapEndpoint"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/admin/billing/subscriptions/{orgId}/plan": {
        ...
        options?: never;
        head?: never;
        /** Change an organization’s plan immediately (no proration; audited) */
    ...
    "/api/v1/admin/feature-flags": {
        ...
        /** List feature flags and organization overrides */
    ...
    "/api/v1/admin/feature-flags/{key}": {
        ...
        options?: never;
        head?: never;
        /** Create or update a feature flag override for an organization */
        patch: operations["AdminFeatureFlagsController_update"];
        trace?: never;
    };
    ...
    "/api/v1/dashboard/people/employees/{id}/breaks": {
        ...
        /** Get an employee's break schedule (placeholder) */
        get: operations["DashboardPeopleController_getBreaksEndpoint"];
        /** Update an employee's break schedule (placeholder) */
...
export interface components {
    schemas: {
        ...
        AssignPermissionsDto: {
            /**
             * @description UUID of the custom role
             * @example 00000000-0000-0000-0000-000000000000
             */
            customRoleId: string;
        ...
        CreateEmailTemplateDto: {
            ...
            nameEn?: string;
            /**
             * @description Arabic email subject line
             * @example تم تأكيد حجزك
             */
            subjectAr: string;
            /**
             * @description English email subject line
        ...
        /**
         * @description Language to render the template in
         * @enum {string}
         */
        PreviewLang: "ar" | "en";
        PreviewEmailTemplateDto: {
             ...
             * @example ar
             */
            lang: components["schemas"]["PreviewLang"];
            /**
        ...
        BookingConfigInputDto: {
            /**
             * @description Booking delivery type
             * @example in_person
             * @enum {string}
             */
        ...
        SetBusinessHoursDto: {
            /**
             * @description UUID of the branch to configure
             * @example 00000000-0000-0000-0000-000000000000
             */
            branchId: string;
        ...
        AddHolidayDto: {
            /**
             * @description UUID of the branch this holiday applies to
             * @example 00000000-0000-0000-0000-000000000000
             */
            branchId: string;
            /**
...
export interface operations {
    ...
    DashboardPlatformController_listFeatureFlagsEndpoint: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody?: never;
        responses: {
            /** @description Array of feature flag records */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    DashboardPlatformController_featureFlagMapEndpoint: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody?: never;
        responses: {
            /** @description Object mapping flag keys to boolean values */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    AdminFeatureFlagsController_update: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpdateFeatureFlagAdminDto"];
            };
        };
        responses: {
            200: {
    ...
    DashboardPeopleController_getBreaksEndpoint: {
        ...
        requestBody?: never;
        responses: {
            /** @description Break list (always empty until schedule-splitting migration) */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    DashboardPeopleController_putBreaksEndpoint: {
        ...
        requestBody?: never;
        responses: {
            /** @description Accepted (no-op until schedule-splitting migration) */
            200: {
                headers: {
                    [name: string]: unknown;
                };
