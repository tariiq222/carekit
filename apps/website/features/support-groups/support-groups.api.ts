...
export async function getPublicGroupSessions(
  ...
  const url = branchId
    ? `${API_BASE}/public/bookings/group-sessions?branchId=${encodeURIComponent(branchId)}`
    : `${API_BASE}/public/bookings/group-sessions`;
...
export async function getPublicGroupSession(
  ...
  const res = await fetch(`${API_BASE}/public/bookings/group-sessions/${encodeURIComponent(groupSessionId)}`, {
...
export async function bookGroupSession(
  ...
  const res = await fetch(`${API_BASE}/public/bookings/group-sessions/${encodeURIComponent(groupSessionId)}/book`, {
    method: 'POST',
    headers: {
