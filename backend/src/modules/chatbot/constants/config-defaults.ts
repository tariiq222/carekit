...
export const CHATBOT_CONFIG_DEFAULTS: ChatbotConfigEntry[] = [
  ...
  { key: 'welcome_message_ar', value: 'مرحباً! أنا مساعدك الذكي. كيف أقدر أساعدك اليوم؟', category: 'personality' },
  { key: 'welcome_message_en', value: 'Hello! I\'m your smart assistant. How can I help you today?', category: 'personality' },
  ...
  { key: 'restricted_topics', value: ['medical_advice', 'diagnosis', 'prescription'], category: 'rules' },
  {
    key: 'restricted_topics_response_ar',
    value: 'عذراً، لا أستطيع تقديم استشارات طبية. يرجى التواصل مع الطبيب مباشرة.',
    category: 'rules',
  },
  {
    key: 'restricted_topics_response_en',
    value: 'Sorry, I cannot provide medical advice. Please consult with a doctor directly.',
    category: 'rules',
  },
  ...
  // ── Quick Replies ──
  {
    ...
    value: [
      ...
      { label_ar: 'مواعيدي', label_en: 'My Appointments', action: 'my_appointments' },
  ...
  { key: 'handoff_message_ar', value: 'سأحولك الآن للتواصل مع فريقنا.', category: 'handoff' },
  { key: 'handoff_message_en', value: 'I will now connect you with our team.', category: 'handoff' },
